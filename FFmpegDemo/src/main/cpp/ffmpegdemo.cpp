...
Java_com_kk_ffmpegdemo_NativeFFmpegDemo_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
...
Java_com_kk_ffmpegdemo_NativeFFmpegDemo_getFFmpegInfo(JNIEnv *env, jobject thiz) {
    char info[40000] = {0};
...
JNIEXPORT jstring JNICALL
Java_com_kk_ffmpegdemo_utils_FFUtils_urlProtocolInfo(JNIEnv *env, jclass clazz) {
    char info[40000] = {0};
    av_register_all();
...
JNIEXPORT jstring JNICALL
Java_com_kk_ffmpegdemo_utils_FFUtils_avFormatInfo(JNIEnv *env, jclass clazz) {
    char info[40000] = {0};
...
JNIEXPORT jstring JNICALL
Java_com_kk_ffmpegdemo_utils_FFUtils_avCodecInfo(JNIEnv *env, jclass clazz) {
    char info[40000] = {0};
...
JNIEXPORT jstring JNICALL
Java_com_kk_ffmpegdemo_utils_FFUtils_avFilterInfo(JNIEnv *env, jclass clazz) {
    char info[40000] = {0};
...
Java_com_kk_ffmpegdemo_utils_FFUtils_playVideo(JNIEnv *env, jclass clazz, jstring videoPath_,
                                               jobject surface) {
