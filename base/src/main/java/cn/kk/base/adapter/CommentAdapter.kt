 ...
 * 评论适配器
 */
class CommentAdapter(val dataList: MutableList<CommentModel>, val activity: Activity): BaseQuickAdapter<CommentModel, BaseViewHolder>(R.layout.item_comment, dataList) {
    ...
    override fun convert(holder: BaseViewHolder, itemModle: CommentModel) {
        ...
        Glide.with(activity).load(R.drawable.head_portrait_empty).into(holder.getView(R.id.iv_avatar))
    }
