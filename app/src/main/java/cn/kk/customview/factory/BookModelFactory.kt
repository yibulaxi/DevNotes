            ...
            when (itemAction) {
                ...
                BaseItem.ACTION_BOOK_AV_DEV -> {
                    chapterModelList.apply {
                        ...
                        add(
                            ItemChapterModel(
                                "入门到提高 —— 任务列表",
                                mutableListOf<ItemSectionModel>().apply {
                                    val chapterOrder = chapterModelList.size + 1
                                    add(
                                        ItemSectionModel(
                        ...
                        add(
                            ItemChapterModel(
                                ...
                                mutableListOf<ItemSectionModel>().apply {
                                    ...
                                    add(
                                        ItemSectionModel(
                                            "JNI 访问 Java 类回调方法 和 子线程访问 Java 类的回调方法",
                                            chapterOrder,
                                            this.size + 1,
                                            true
                                        )
                ...
                BaseItem.action_book_android_dev_art -> {
                    ...
                    return BookModel(
                        ...
                        itemAction,
                        chapterModelList
                    ).apply { bookImgRes = R.drawable.bg_book_1 }
                }
                // endregion
                ...
                BaseItem.action_book_linux -> {
                    ...
                    return BookModel(
                        ...
                        itemAction,
                        chapterModelList
                    ).apply { bookImgRes = R.drawable.bg_book_2 }
                }
                // endregion
                ...
                BaseItem.action_book_android_custom_view_elementary -> {
                    ...
                    return BookModel(
                        ...
                        itemAction,
                        chapterModelList
                    ).apply { bookImgRes = R.drawable.bg_book_3 }
                }
                // endregion
                ...
                BaseItem.action_book_android_advance -> {
                    ...
                    return BookModel(
                        ...
                        itemAction,
                        chapterModelList
                    ).apply { bookImgRes = R.drawable.bg_book_4 }
                }
                // endregion
                ...
                BaseItem.action_book_android_programming -> {
                    ...
                    // more info
                    moreInfoList.apply {
                        add(BaseMoreItem("GeoQuiz", "").apply {
                            item_action = BaseItem.ACTION_BOOK_ANDROID_PROGRAMMING_APP_BEATBOX
                        })
                        add(BaseMoreItem("BeatBox", "").apply {
                            item_action = BaseItem.ACTION_BOOK_ANDROID_PROGRAMMING_APP_BEATBOX
                        })
                        add(BaseMoreItem("CriminalIntent", "").apply {
                            item_action = BaseItem.ACTION_BOOK_ANDROID_PROGRAMMING_APP_BEATBOX
                        })
                        add(BaseMoreItem("NerdLauncher", "").apply {
                            item_action = BaseItem.ACTION_BOOK_ANDROID_PROGRAMMING_APP_BEATBOX
                        })
                        add(BaseMoreItem("PhotoGallery", "").apply {
                            item_action = BaseItem.ACTION_BOOK_ANDROID_PROGRAMMING_APP_BEATBOX
                        })
                        add(BaseMoreItem("DragAndDraw", "").apply {
                            item_action = BaseItem.ACTION_BOOK_ANDROID_PROGRAMMING_APP_BEATBOX
                        })
                        add(BaseMoreItem("Sunset", "").apply {
                            item_action = BaseItem.ACTION_BOOK_ANDROID_PROGRAMMING_APP_BEATBOX
                        })
                    }
                ...
                BaseItem.action_book_git -> {
                    ...
                    return BookModel("Git", itemAction, chapterModelList).apply {
                        bookImgRes = R.drawable.bg_book_6
                    }
                }
                // endregion
                ...
                BaseItem.action_book_android_arch -> {
                    ...
                    return BookModel(
                        ...
                        itemAction,
                        chapterModelList
                    ).apply { bookImgRes = R.drawable.bg_book_7 }
                }
                // endregion
                ...
                BaseItem.action_book__android_plugin -> {
                    ...
                    return BookModel(
                        ...
                        itemAction,
                        chapterModelList
                    ).apply { bookImgRes = R.drawable.bg_book_8 }
                }
                // endregion
                ...
                BaseItem.action_book_android_hot_fix -> {
                    ...
                    return BookModel(
                        ...
                        itemAction,
                        chapterModelList
                    ).apply { bookImgRes = R.drawable.bg_book_9 }
                }
                // endregion
                ...
                BaseItem.action_book_ffmpeg -> {
                    chapterModelList.apply {
                        ...
                        add(
                            ItemChapterModel(
                                "第 10 章 FFmpeg 接口 libavfilter 的使用",
                                mutableListOf<ItemSectionModel>().apply {
                    ...
                    return BookModel(
                        ...
                        itemAction,
                        chapterModelList
                    ).apply { bookImgRes = R.drawable.bg_book_10 }
                }
                // endregion
                ...
                BaseItem.action_book_data_arch -> {
                    ...
                    return BookModel("大话数据结构", itemAction, chapterModelList).apply {
                        bookImgRes = R.drawable.bg_book_11
                    }
                }
                // endregion
                ...
                BaseItem.action_book_python -> {
                    ...
                    return BookModel(
                        ...
                        itemAction,
                        chapterModelList
                    ).apply { bookImgRes = R.drawable.bg_book_12 }
                }
                // endregion
                ...
                BaseItem.action_book_http -> {
                    ...
                    return BookModel("图解 Http", itemAction, chapterModelList).apply {
                        bookImgRes = R.drawable.bg_book_13
                    }
                }
                // endregion
                ...
                BaseItem.action_book_java_easy_coding -> {
                    ...
                    return BookModel(
                        ...
                        itemAction,
                        chapterModelList
                    ).apply { bookImgRes = R.drawable.bg_book_14 }
                }
                // endregion
